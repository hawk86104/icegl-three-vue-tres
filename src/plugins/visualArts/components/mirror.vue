...
lights (){
    let h_light = new THREE.HemisphereLight(0xffffff, 0xaaaacc, 1);
    let p_light = new THREE.PointLight(0xffffff, 0.2);
 ...
 capsule() {
   ...
   object() {
    ...
    const o_mat = new THREE.MeshMatcapMaterial({
     ...
     let c_mes = new THREE.Mesh(c_geo, o_mat);
   let o_mes = new THREE.Mesh(o_geo, o_mat);
