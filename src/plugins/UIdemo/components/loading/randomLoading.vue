 ...
 * @LastEditors: 地虎降天龙
 * @LastEditTime: 2024-06-11 16:00:56
-->
...
paneState.styleNum = Math.floor(Math.random() * 24)
paneState.showProgress = Math.random() < 0.5
console.log(paneState.styleNum, paneState.showProgress)
</script>
