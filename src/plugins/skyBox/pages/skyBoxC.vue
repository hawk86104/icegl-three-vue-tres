...
<template>
	<TresCanvas v-bind="tcConfig">
		...
		<Suspense>
			<skyBox texture="https://opensource-1314935952.cos.ap-nanjing.myqcloud.com/images/skyBox/desert_1k.hdr" />
		</Suspense>
	</TresCanvas>
</template>
...
import skyBox from 'PLS/skyBox/components/skyBoxCmesh.vue'
